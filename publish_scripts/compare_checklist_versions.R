...
#      
# 
### the april script cleanup scare ###
v1 <- readRDS("data/apg_wcp_jun_20_clean.rds") # the ones i have been using all the time
v2 <- readRDS("processed_data/apg_wcp_jun_20_clean.rds") # the one def version 2020, just created

v19 <- readRDS("processed_data/apg_wcp_dec_19_clean.rds") # version 19, just created
v_server <- readRDS("data/apg_wcp_jun_20_clean_SERVER.rds") # version server
