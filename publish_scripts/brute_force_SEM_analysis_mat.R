...
# sr_variables <- c("sub_trop_dbf",  "pre_sd", "mont_gs" , "pre_m", "sea_sd", "tra_m", "mat_m" ,"tra_sd", "mat_sd" , "sea_m"
#                   , "medit_fws" , "temp_gss" , "tri" , "pet_sd" , "pet_m")
# mrd_variables <- c("tra_m", "sea_sd", "soil" , "tri", "tra_sd" , "pre_sd" , "pet_m", "mat_m" , "area", "mat_sd" ,
#                   "temp_bmf" , "sub_trop_mbf" , "pet_sd" , "medit_fws" , "sub_trop_cf" , "deserts_x_shrub")
...
sr_variables <- c("sub_trop_dbf",  "pre_sd", "mont_gs", "mat_sd", "tri", "sea_sd", "tra_m", "tra_sd", "pre_m", "pet_sd", 
                  "sea_m", "mat_m") 
# tri + pet_sd are new, sea_m + mat_m missing
...
png("best_cfi_mod_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
png("best_rmsea_mod_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
png("best_global_aic_mod_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
semPaths(object = best_global_aic.mod.fit3, layout = "circle2", rotation = 1,
         whatLabels="std", label.cex = 1.5, edge.label.cex = 1, what = "std", 
         exoCov = FALSE, exoVar = FALSE,
         nCharNodes = 0, fade=FALSE,
         edgeLabels = sem_sig_labels(best_global_aic.mod.fit3))
title(round(fitmeasures(best_global_aic.mod.fit3, c("cfi.robust", "rmsea.robust", "aic")),3), cex.main=1)
dev.off()
...
nrow(fin_good)
# 609 for 0.13 and pet_m, 722 for mat_m
...
nrow(fin_good_aic) # 21 good models with lowest AIC + max 2 more aic points = set of basically identical AICs
fin_good_aic[,-7]
### most variables
...
png("best_aic_mod_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
semPaths(object = best_aic.fit.mod3, layout = "circle2", rotation = 1,
         whatLabels="std", label.cex = 1.5, edge.label.cex = 1, what = "std", 
         exoCov = FALSE, exoVar = FALSE,
         nCharNodes = 0, fade=FALSE,
         edgeLabels = sem_sig_labels(best_aic.fit.mod3))
title(round(fitmeasures(best_aic.fit.mod3, c("cfi.robust", "rmsea.robust", "aic")),3), cex.main=1)
dev.off()
...
cat(best_abs_aic_mod2)

png("best_absolute_aic_mod_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
semPaths(object = best_abs_aic.fit.mod2, layout = "circle2", rotation = 1,
         whatLabels="std", label.cex = 1.5, edge.label.cex = 1, what = "std", 
         exoCov = FALSE, exoVar = FALSE,
         nCharNodes = 0, fade=FALSE,
         edgeLabels = sem_sig_labels(best_abs_aic.fit.mod2))
title(round(fitmeasures(best_abs_aic.fit.mod2, c("cfi.robust", "rmsea.robust", "aic")),3), cex.main=1)
dev.off()
...
nrow(fin_good_max.var) # 2 good models with max var

cat(fin_good_max.var$model.name)
# the second model has multicollineraty issues in MRD --> out
max.var.mod <- fin_good_max.var$model.name[1]
...
png("max_var_MAT.png", width=900, height=500, units = "px")
par(mfrow=c(1,2))
...
semPaths(object = max.var.mod.fit.mod5, layout = "circle2", rotation = 1,
         whatLabels="std", label.cex = 1.5, edge.label.cex = 1, what = "std", 
         exoCov = FALSE, exoVar = FALSE,
         nCharNodes = 0, fade=FALSE,
         edgeLabels = sem_sig_labels(max.var.mod.fit.mod5))
title(round(fitmeasures(max.var.mod.fit.mod5, c("cfi.robust", "rmsea.robust", "aic")),3), cex.main=1)
dev.off()
...
semPaths(object = max.r2.fit.mod2, layout = "circle2", rotation = 1,
         whatLabels="std", label.cex = 1.5, edge.label.cex = 1, what = "std", 
         exoCov = FALSE, exoVar = FALSE,
         nCharNodes = 0, fade=FALSE,
         edgeLabels = sem_sig_labels(max.r2.fit.mod2))
title(round(fitmeasures(max.r2.fit.mod2, c("cfi.robust", "rmsea.robust", "aic")),3), cex.main=1)
dev.off()
...
save.image("brute_force_models.RData")
