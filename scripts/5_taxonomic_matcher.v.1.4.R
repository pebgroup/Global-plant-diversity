...
#   DB.name <- "NCBI"
#   data_folder_path <- "data/" # depends on where your working directory is set (source file VS project location)
#   results_folder_path <- "results/"
#   
#   ## specify input file names:
#   ncbi_input_filename <- "NCBI.apg.rds"
# #  wcsp_input_filename <- "apg_wcp_jun_20_clean.rds"
#   wcsp_input_filename <- "apg_wcp_jul_21_clean.rds"
# #  bien_input_filename <- "bien_input_vectorized3.apg.rds"
#   bien_input_filename <- "apg_bien_common_format_no_centroids.rds"
# #  bien_input_filename <- "apg_bien_common_format_Sep21.rds"
# #  bien_input_filename <- "apg_bien_common_format_Sep21_download_Jan2020.rds"
#   gbif_input_filename <- "input_tip_labels_new_sript.rds"
# 
#   year <- parse_number(wcsp_input_filename)
#   
#   # output
...
#   fin_file_species <- paste0("fin_species_match_", DB.name, "_wcvp", year,".rds")
  ...
  # #convert to character | not needed anymore
  # d.as.chr <- function(x){
