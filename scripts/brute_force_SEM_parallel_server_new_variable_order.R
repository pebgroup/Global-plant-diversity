...
# sr_variables <- c("sub_trop_dbf",  "pre_sd", "mont_gs", "mat_sd", "tri", "sea_sd", "tra_m", "tra_sd", 
#                   "pre_m", "pet_sd", "sea_m", "mat_m")
...
save(temp, file="brute_force_mod_selection_results_parallel_mat_new_order.RData")
